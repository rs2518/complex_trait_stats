...
seed = 1
max_iter = 10000
l2_space = np.logspace(-5, 5, 11)
parameters = {'alpha': l2_space}
...
plt.semilogx(l2_space, mean_train_scores, color = 'navy')
plt.semilogx(l2_space, mean_train_scores + std_train_scores,
...
plt.fill_between(l2_space, mean_train_scores + std_train_scores,
...
plt.semilogx(l2_space, mean_val_scores, color = 'purple')
plt.semilogx(l2_space, mean_val_scores + std_val_scores,
...
plt.fill_between(l2_space, mean_val_scores + std_val_scores,
...
coefs = np.append(ridge_cv.best_estimator_.intercept_,
...
ridge_metrics = metrics_table(y_test, y_pred)
print(ridge_metrics)
...
### NOTE: Not a good predictive model. Most predictions are approx. 0.5
# Worse fit than LASSO
